 ...
 * 
 * Otra clase leeráeste fichero eimprimirá por pantalla el contenido.
 * 
...
public class CrearFichero01 {
	...
	public static void main(String[] args) {
		...
		try {
			fichero = new FileWriter(path + "NombreApellidos.txt"); // Abro el fichero para Escritura, si no existe lo crea.
